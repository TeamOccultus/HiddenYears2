...
export const COPPER_APPLE = new quest.Quest(
  ...
  { condition: HyQuestCondition.copperApple, award: HyQuestAward.goldenApple3 }
);
export const METAL_STAR = new quest.Quest(
  "metal_star",
  "§d[策划大失败]§r 半吊子引雷士",
  "这个东西理论上可以引雷，啊嘞，怎么引不了了……",
  { condition: HyQuestCondition.metalStar, award: HyQuestAward.diamondCoin9 }
);
export const COPPER_ESSENCE = new quest.Quest(
  "copper_essence",
  "§d[策划大失败]§r 没有用的东西",
  "恭喜你，获得了此模组最没有用的东西！！！（是的，我在写这句话的时候也都忘了这个东西叫啥了）",
  { condition: HyQuestCondition.copperEssence, award: HyQuestAward.dirt12 }
);
...
export const BEGGING = new quest.Quest(
  ...
  "§d[序幕]§r 一切的开始",
  "这是树上新生的枝桠，亦是你旅途的起点……",
  { condition: HyQuestCondition.stick, award: HyQuestAward.goldCoin5 }
);
...
export const OVER_METAL_INGOT = new quest.Quest(
  ...
  { condition: HyQuestCondition.overMetalIngot, award: HyQuestAward.goldCoin6 }
);
...
export const IRON_INGOT = new quest.Quest(
  ...
  { condition: HyQuestCondition.ironIngot, award: HyQuestAward.goldCoin10 }
);
...
export const COPPER_INGOT = new quest.Quest(
  ...
  { condition: HyQuestCondition.copperIngot, award: HyQuestAward.questBook1 }
);
...
export const IRON_HAMMER = new quest.Quest(
  ...
  { condition: HyQuestCondition.ironHammer, award: HyQuestAward.goldCoin12 }
);
...
export const IRON_CROWBAR = new quest.Quest(
  ...
  { condition: HyQuestCondition.ironCrowbar, award: HyQuestAward.goldCoin16 }
);
...
export const IRON_KNIFE = new quest.Quest(
  ...
  { condition: HyQuestCondition.ironKnife, award: HyQuestAward.goldCoin18 }
);
...
export const IRON_DAGGER = new quest.Quest(
  ...
  { condition: HyQuestCondition.ironDagger, award: HyQuestAward.goldCoin20 }
);
...
export const IRON_SWORD = new quest.Quest(
  ...
  { condition: HyQuestCondition.ironSword, award: HyQuestAward.goldenApple3 }
);
...
export const SUFFERING_SWORD = new quest.Quest(
  ...
  { condition: HyQuestCondition.sufferingSword, award: HyQuestAward.diamond5 }
);
...
export const STEEL_INGOT = new quest.Quest(
  ...
  { condition: HyQuestCondition.steelIngot, award: HyQuestAward.goldCoin20 }
);
...
export const TOTEM = new quest.Quest(
  ...
  { condition: HyQuestCondition.totem, award: HyQuestAward.storyBook }
);
...
export const OBSIDIAN = new quest.Quest(
  ...
  { condition: HyQuestCondition.obsidian, award: HyQuestAward.diamondCoin3 }
);
...
export const GOLD_INGOT = new quest.Quest(
  ...
  { condition: HyQuestCondition.goldIngot, award: HyQuestAward.goldCoin12 }
);
...
export const GHAST_TEAR = new quest.Quest(
  ...
  { condition: HyQuestCondition.ghastTear, award: HyQuestAward.goldenApple5 }
);
...
export const LODESTONE = new quest.Quest(
  ...
  "一种神奇的东西",
  { condition: HyQuestCondition.lodestone, award: HyQuestAward.goldCoin30 }
);
...
export const RESPAWN_ANCHOR = new quest.Quest(
  ...
  { condition: HyQuestCondition.respawnAnchor, award: HyQuestAward.copperBadge }
);
...
export const BLAZE_ROD = new quest.Quest(
  ...
  { condition: HyQuestCondition.blazeRod, award: HyQuestAward.goldenBadge }
);
...
export const NETHER_STAR = new quest.Quest(
  ...
  { condition: HyQuestCondition.netherStar, award: HyQuestAward.diamondBlock6 }
);
...
export const ENDER_PEARL = new quest.Quest(
  ...
  "§d[空中群岛]§r 隔墙有眼",
  "苍穹之上、星海之下有着什么呢……",
  { condition: HyQuestCondition.enderPearl, award: HyQuestAward.enderEye4 }
);
...
export const DRAGON_BREATH = new quest.Quest(
  ...
  "§d[空中群岛]§r 你需要来点薄荷糖",
  "浓痰……能干啥呢……",
  { condition: HyQuestCondition.dragonBreath, award: HyQuestAward.diamondBadge }
);
...
export const DRAGON_EGG = new quest.Quest(
  ...
  { condition: HyQuestCondition.dragonEgg, award: HyQuestAward.netheriteBlock6 }
);
...
export const RUBY = new quest.Quest(
  ...
  "§d[淬血的刚玉]§r 沾满鲜血的宝石",
  "这宝石本纯洁无瑕，直到鲜血洒在了其上……",
  { condition: HyQuestCondition.ruby, award: HyQuestAward.diamond2 }
);
...
export const RUBY_CHESTPLATE = new quest.Quest(
  ...
  "§d[淬血的刚玉]§r 满身鲜血",
  "用这来之不易的宝石打造一套甲胄吧",
  { condition: HyQuestCondition.rubyChestplate, award: HyQuestAward.diamond4 }
);
...
export const RUBY_BAG = new quest.Quest(
  ...
  { condition: HyQuestCondition.rubyBag, award: HyQuestAward.diamond6 }
);
...
export const RUBY_RUNES = new quest.Quest(
  ...
  { condition: HyQuestCondition.rubyRunes, award: HyQuestAward.netheriteIngot3 }
);
...
export const STORY_BOOK = new quest.Quest(
  ...
  "§d[书海无涯]§r 故事的起点",
  "获得隐藏的故事",
  { condition: HyQuestCondition.storyBook, award: HyQuestAward.diamond1 }
);
...
export const LETTER_0 = new quest.Quest(
  ...
  "§d[书海无涯]§r 千里之行始于足下",
  "获得散落的信纸·千里之行与脚下之路",
  { condition: HyQuestCondition.letter0, award: HyQuestAward.diamond2 }
);
...
export const LETTER_11 = new quest.Quest(
  ...
  "§d[书海无涯]§r 大历史学家",
  "搜刮黑森林中某处囚笼，获得精灵史摘要",
  { condition: HyQuestCondition.letter11, award: HyQuestAward.diamond2 }
);
